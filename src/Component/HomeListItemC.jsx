...
function HomeListItemC() {
  ...
  return (
    <div>
      ...
      <span>print each element one by one using map .my arr is ["a","b","c"]</span>
      <div>{arr1.map((item)=>{
        return<div>{item}</div>
      })}</div>
      ...
      <div>{arr4.map((item)=>{
       ...
       <span>print each element one by one using map .my arr is arr4 but use span tag</span>
      <div>{arr4.map((item)=>{
      ...
      <div>{arr5.map((item)=>{
       ...
       <span>print each element one by one using map .my arr is arr5 but use span tag</span>
      <div>{arr5.map((item)=>{
        return<span>{item}</span>
      })}</div>
